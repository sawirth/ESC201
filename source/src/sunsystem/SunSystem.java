...
public class SunSystem extends JPanel {
    ...
    private void run() {
        ...
        for (int i = 0; i < N; i++) {
            XYSeries series = new XYSeries("Series " + i, false);
    ...
    class Planet {
        ...
        Planet(double mass, double r[], double[] v) {
            this.r = r.clone();
            this.v = v.clone();
            this.mass = mass;
    ...
    Planet merkur = new Planet( 1.0/6023600,
    ...
    Planet venus = new Planet( 1.0/408523.61,
    ...
    Planet erdemond = new Planet( 1.0/332946.050895,
    ...
    Planet mars = new Planet( 1.0/3098708,
    ...
    Planet jupiter = new Planet( 1.0/1047.3486,
    ...
    Planet saturn = new Planet( 1.0/3497.898,
    ...
    Planet uranus = new Planet( 1.0/22902.98,
    ...
    Planet neptun = new Planet( 1.0/19412.24,
    ...
    Planet pluto = new Planet( 1.0/135200000,
